...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Coloca aquí la URL de tu canción
    ...
    function playMusic() {
        try {
            ...
            if (!audio) {
                ...
                audio.loop = true; // La música se repetirá automáticamente
                audio.volume = 0.5; // Volumen al 50% (puedes cambiar de 0.0 a 1.0)
            }
            audio.play().catch(e => {
                console.log("Error al reproducir música:", e);
            });
        } catch (e) {
            console.log("Error al inicializar música:", e);
        }
    }
